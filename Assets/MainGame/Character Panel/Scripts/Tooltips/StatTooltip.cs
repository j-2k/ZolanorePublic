...
public class StatTooltip : MonoBehaviour
{
    ...
    [SerializeField] TextMeshProUGUI HeaderModifierText;
    ...
    private string GetStatTopText(CharacterStat stat, string statName)
    {
        ...
        if (stat.Value != stat.BaseValue)
        {
            ...
            sb.Append(System.Math.Round(stat.Value - stat.BaseValue, 2));
            sb.Append(")");
        }
    ...
    private string GetStatModifiersText(CharacterStat stat)
    {
        ...
        foreach (StatModifier mod in stat.StatModifiers)
        {
            ...
            EquippableItem equippableItem = mod.Source as EquippableItem;

            if (equippableItem != null)
            {
                sb.Append(" ");
                sb.Append(equippableItem.ItemName);
            }
            else
            {
